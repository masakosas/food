...
<div class="restaurant-container px-2">
  <div
    class="restaurant overflow-hidden rounded-xl pb-4 mb-4 shadow-md shadow-gray-300"
    :class="[cardHeight]"
  >
      ...
      <div class="additional-info flex items-center">
        <div class="delivery-info flex items-center">
          <div class="delivery-type">
              <img
              :src="`/images/${restaurant.willBeDeliveredBy}-icon.svg`"
              :alt="restaurant.willBeDeliveredBy"
              class="icon"
              >
          </div>
          <div class="delivery-time mx-1">
            {{
              delivery.lowLimitMinutes
            }}
            -
            {{
              delivery.upperLimitMinutes
            }}
            мин
          </div>
        </div>
